...
getWeatherData = (city) => {
  ...
  const FULL_URL = `${URL}?q=${city}&appid=${API_KEY}&uints=imperials`
  //CODE GOES HERE
...
showWeatherData = (weatherData) => {
  //CODE GOES HERE
  document.getElementById("city-name").innerText = weatherData.name;//left hand side of the equation is used to get the id and equate it and show it in the app
